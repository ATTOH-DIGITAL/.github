...
| *Untagged* | 9 | Not yet carrying a `venture-*` topic — tag them and they move into a row above. | — |
...
## AMAYA Core — what's inside

`Attohdigital` (Craig's/AMAYA's repo) and `brg-operations` hold most of the estate's actual product surface as nested folders rather than separate repos — easy to miss if you only browse the org repo list:

- **33 verticals** (law/finance/property AI products) — `Attohdigital/_verticals/`
- **21-tool Snap Suite** (lead-magnet tools: CADSNAP, TRADESNAP, etc.) — `Attohdigital/_modules/snaptools/`
- **App Builder** (prompt → assembled, deployed app) — `brg-operations/_web/app-builder*`
- **BRG agent platform** — UK SME intelligence, compliance, finance, growth automation

---

<div align="center">
<sub>AMAYA Holdings Ltd · <a href="mailto:craig@incorpwise.co.uk">craig@incorpwise.co.uk</a></sub>
</div>
